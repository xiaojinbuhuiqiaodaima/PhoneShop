...
export const changeGoodsCount = (goods_id, count, user_id) =>
  ajax(
    BASE_URL + "/api/change_goods_count",
    { goods_id, count, user_id },
    "POST"
  );
...
export const deleteUser = id =>
  ajax(BASE_URL + "/api/delete_user", { id }, "POST");
...
export const addOrder = params =>
  ajax(BASE_URL + "/api/add_order", params, "POST");

// 获取所有该用户的订单
export const getUserOrders = user_id =>
  ajax(BASE_URL + "/api/get/order", { user_id }, "POST");

// 获取所有的订单
export const getAdminOrders = () =>
  ajax(BASE_URL + "/api/get/admin_order", {}, "POST");
